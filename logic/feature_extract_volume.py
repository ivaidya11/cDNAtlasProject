...
# AA_VOLUME_CLASS = {
#     'G': 'tiny',  'A': 'tiny',
#     'S': 'small', 'T': 'small', 'C': 'small', 'V': 'small', 'P': 'small',
#     'L': 'medium','I': 'medium','N': 'medium','D': 'medium',
#     'Q': 'medium','E': 'medium','K': 'medium','M': 'medium',
#     'H': 'large', 'F': 'large', 'R': 'large', 'Y': 'large', 'W': 'large',
# }

# updated to match volume classes from the table (Å³):
...
final_save_path = 'data/updated_features_volume.csv'
...
df_features['volume_class'] = [AA_VOLUME_CLASS.get(aa, 'Unknown') for aa in df_features['amino_acid']]
